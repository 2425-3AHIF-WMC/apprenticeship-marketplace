...
export async function insertSampleData(unit: Unit): Promise<void> {
    ...
    async function insert(): Promise<void> {
        await pool.query(`
            ...
            VALUES 
            ('CarlaCo Enterprises', '890123a', 'Business-Lösungen für moderne Unternehmen', 'https://carlaco.com', 'info@carlaco.com', '06641234567', 'pass123', 'Y', 'Y', NOW(), null, null, 'company-logos/1.png'),
            ('Elektronic Design', '901234b', 'Elektronikentwicklung und PCB Design', 'https://elektronicdesign.com', 'contact@elektronicdesign.com', '06761234567', 'pass123', 'N', 'N', NOW(), null, null, 'company-logos/2.png'),
            ('Elysee Industries', '912345c', 'Industrielösungen und Automation', 'https://elyseeindustries.com', 'service@elyseeindustries.com', '0316123456', 'pass123', 'Y', 'N', NOW(), null, null, 'company-logos/3.png'),
            ('IT Media Solutions', '923456d', 'Digitale Medien- und IT-Dienstleistungen', 'https://itmediasolutions.com', 'hello@itmediasolutions.com', '06991234567', 'pass123', 'Y', 'Y', NOW(), null, null, 'company-logos/4.png'),
            ('LT Studios', '934567e', 'Kreative Studio- und Designlösungen', 'https://lt-studios.com', 'studio@lt-studios.com', '0720123456', 'pass123', 'N', 'N', NOW(), null, null, 'company-logos/5.png'),
            ('LuminaTech', '945678f', 'Beleuchtungstechnologien der Zukunft', 'https://luminatech.com', 'kontakt@luminatech.com', '06601234567', 'pass123', 'Y', 'Y', NOW(), null, null, 'company-logos/6.png'),
            ('MeliCorp', '956789g', 'Globale Logistik- und Handelslösungen', 'https://melicorp.com', 'info@melicorp.com', '01 23456789', 'pass123', 'Y', 'Y', NOW(), null, null, 'company-logos/7.png'),
            ('Nebula Dynamics', '967890h', 'Cloud Computing & Datenanalyse', 'https://nebuladynamics.com', 'team@nebuladynamics.com', '0732123456', 'pass123', 'Y', 'N', NOW(), null, null, 'company-logos/8.png'),
            ('Nexus Solutions', '978901i', 'Innovative Unternehmenssoftware', 'https://nexussolutions.com', 'support@nexussolutions.com', '0551223456', 'pass123', 'Y', 'Y', NOW(), null, null, 'company-logos/9.png'),
            ('TechMed Innovations', '989012j', 'Medizintechnologie & Forschung', 'https://techmedinnovations.com', 'contact@techmedinnovations.com', '06641230000', 'pass123', 'N', 'N', NOW(), null, null, 'company-logos/10.png'),
            ('ZenithTech', '990123k', 'High-End Technologieentwicklung', 'https://zenithtech.com', 'info@zenithtech.com', '0463123456', 'pass123', 'N', 'N', NOW(), null, null, 'company-logos/11.png');
