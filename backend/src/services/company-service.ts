...
export class CompanyService extends ServiceBase {
    ...
    public async update(company: ICompany): Promise<boolean> {
        const stmt = await this.unit.prepare(`update company set name=$1 , company_number=$2, company_info=$3, website=$4, email=$5, phone_number=$6, password=$7, email_verified=$8, admin_verified=$9, company_registration_timestamp=$10, email_verfication_timestamp=$11, admin_verification_timestamp=$12 where company_id=$13`, [
            company.name,
